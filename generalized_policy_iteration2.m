...
function [V, policy_index] = ...
    generalized_policy_iteration2(world, precision_pi, ...
    ...
    while true
        ...
        while true
            ...
            for x = 1:num_states
                ...
                for i = 1:size(next_state,2)
                    V_i = T{1,curr_policy}(x,next_state(i))...
                    *(R{1,curr_policy}(x,next_state(i)) ...
                    + gamma * V(next_state(i)));
                    V_x = V_x + V_i;
                end
                V(x) = V_x;
        ...
        for x = 1:num_states           
            ...
            policy(x,1:num_actions) = zeros(1,num_actions);
